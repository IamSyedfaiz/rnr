                        ...
                        <nav class=" mt-5">
                            <div class="nav nav-tabs  nav-pills" id="nav-tab" role="tablist">
                                ...
                                <button class="nav-link" id="nav-contact-tab" data-bs-toggle="tab"
                                    ...
                                    aria-selected="false">DATA MAP</button>
                                <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab"
                                    data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile"
                                    aria-selected="false">Key Field Definition</button>
                                <button class="nav-link" id="nav-filter-tab" data-bs-toggle="tab"
                                    ...
                                    aria-selected="false">RUN CONFIGURATION</button>
                            </div>
                        </nav>
                        <form class="form-horizontal  mt-5" method="POST" action="{{ route('url.local.upload') }}"
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                                    ...
                                    <div class="form-group{{ $errors->has('excel_file') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-6">
                                            <input id="excel_file" type="text" class="form-control" name="excel_file"
                                                value="{{ @$dataUrls->excel_file }}" required>
                                    ...
                                    <div class="form-horizontal row ">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input type="date" name="start_day" class="form-control"
                                                value="{{ @$dataUrls->start_day }}" placeholder="Day of the month"
                                                min="1" max="31">
                                        </div>
                                        <div class="col-6">
                                        ...
                                        <div id="weekDayInput" class="col-6" style="display: none;">
                                            <label for="selectedDay" class="form-label">Select Day of the Week</label>
