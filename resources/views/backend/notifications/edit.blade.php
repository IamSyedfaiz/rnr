        ...
        <div class="pagetitle">
            <div class="row">
                ...
                <div class="col-md-6 text-end">
                    <a href="{{ route('notifications.show', $notification->application_id) }}" class="btn btn-secondary"><i
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <select name="recurring" class="form-control"
                                                            ...
                                                            <option value="instantly"
                                                                ...
                                                                Instantly</option>
                                                            <option value="daily"
                                                                {{ $notification->recurring == 'daily' ? 'selected' : '' }}>
                                                                Daily
                                                            </option>
                                                            <option value="weekly"
                                                                {{ $notification->recurring == 'weekly' ? 'selected' : '' }}>
                                                                Weekly
                                                            </option>
                                                            <option value="monthly"
                                                                {{ $notification->recurring == 'monthly' ? 'selected' : '' }}>
                                                                Monthly
                                                            </option>
                                                            ...
                                                            <option value="reminder"
                                                                {{ $notification->recurring == 'reminder' ? 'selected' : '' }}>
                                                                Reminder
                                                            </option>
                                                        </select>
