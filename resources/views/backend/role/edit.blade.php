            ...
            <div class="bg-light rounded h-100 p-4">
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        ...
                        <form action="{{ route('role.update', $applicationrole->id) }}" class="form-horizontal"
                            method="post">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    ...
                                    value="{{ $applicationrole->name }}" required>
                                @error('name')
                                    ...
                                    <div class="mb-3">
                                        <div class="usergrouplist">
                                            <div class="d-flex justify-content-between mb-2">
                                                ...
                                                <div class="col-md-3 addApplication">
                                                    <button type="button" class="btn btn-primary text-end"
                                                        data-bs-toggle="modal" data-bs-target="#exampleModalApplication"
                                                        data-bs-whatever="@mdo">Add Applications</button>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="mb-3 text-start">
                                                                        <label
                                                                            for="filter">Application&nbsp;</label><input
                                                                            id="filter" type="text"
                                                                            class="filter form-control"
